...
CREATE VIEW StudentHobbiesView AS SELECT Hobbies.StudentId AS StudentId, group_concat(HobbyList.HobbyId) AS HobbyId FROM Hobbies JOIN HobbyList USING (Hobby)
GROUP BY StudentId;
